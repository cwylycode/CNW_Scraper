...
class Options: 
    ...
    :include_description: Change to false if you don't want your collected profiles to include the description portion (which can be lengthy and arguably needless for data processing).
    """
    custom_user_agent = ""
